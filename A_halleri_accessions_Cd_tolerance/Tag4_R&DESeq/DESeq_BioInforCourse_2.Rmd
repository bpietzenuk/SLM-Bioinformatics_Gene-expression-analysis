...
author: "Justin Anderson, Björn Pietzenuk and Lara Syllwasschy"
date: "2018"
...
```{r}
# 1) Load and merge
    # First load the A. halleri gene annotation data with A. thaliana orthologues (HallerotoThalianaGenes.csv) with the Import Dataset button and copy and paste the code here (adjust name if necessary):
 
Hatoath<-___

    # Then merge with the Counts dataframe using the column "Gene" 
  RPKM_df = merge(___,___,by="___")
